...
class PricingEngineTest {
    ...
    void testTotalSummationWithMultipleItems() {
    	...
    	// (150) = 150. Regular + No Discount = 0% discount ($0). 
    ...
    void testRegularCustomerwithNoDiscount() {
        ...
        double result = engine.calculate(standardPrice, standardQty, "REGULAR", null);
    ...
    void testRegularCustomerwithSAVE10() {
        ...
        double result = engine.calculate(standardPrice, standardQty, "REGULAR", "SAVE10");
    ...
    void testRegularCustomerwithSAVE20() {
        ...
        double result = engine.calculate(standardPrice, standardQty, "REGULAR", "SAVE20");
    ...
    void testVIPCustomerwithNoDiscount() {
        ...
        double result = engine.calculate(standardPrice, standardQty, "VIP", null);
    ...
    void testVIPCustomerwithSAVE10() {
        ...
        double result = engine.calculate(standardPrice, standardQty, "VIP", "SAVE10");
    ...
    void testVIPCustomerwithSAVE20() {
        ...
        double result = engine.calculate(standardPrice, standardQty, "VIP", "SAVE20");
